...
class Good_class():
    def __init__(self, dt = 0.01, lr = 0.001 , semple_lenth = 10):
        ...
        self.states_list = []
        self.semple_lenth = semple_lenth
...
if __name__ == '__main__':
    ...
    reg = Good_class(dt = dt, lr = lr, semple_lenth = semple_lenth)
    d_m = DinamicsModule(x=state[0], y=state[1], dt=dt)
